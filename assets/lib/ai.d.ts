declare module behaviourTree {
    ...
    abstract class Behavior<T> {
        status: TaskStatus;
        abstract update(context: T, dt: number): TaskStatus;
        /**
         * 使该节点的状态无效。
         ...
         * @returns
         */
        tick(context: T, dt: number): TaskStatus;
    }
}
declare module behaviourTree {
    /**
...
declare module behaviourTree {
    ...
    class BehaviorTreeReference<T> extends Behavior<T> {
        ...
        update(context: T, dt: number): TaskStatus;
    }
}
declare module behaviourTree {
    /**
...
declare module behaviourTree {
    ...
    abstract class Composite<T> extends Behavior<T> {
         ...
         */
        protected updateSelfAbortConditional(context: T, statusCheck: TaskStatus, dt: number): void;
        /**
         ...
         */
        protected updateLowerPriorityAbortConditional(context: T, statusCheck: TaskStatus, dt: number): void;
        /**
...
declare module behaviourTree {
    ...
    class ConditionalDecorator<T> extends Decorator<T> implements IConditional<T> {
         ...
         */
        executeConditional(context: T, dt: number, forceUpdate?: boolean): TaskStatus;
    }
}
declare module behaviourTree {
    /**
